...
export const trackClasses: ClassData[] = [
  // ── 稲置学園 ──
  {
    ...
    description: '金沢星稜大学陸上部の大学生が楽しく指導！専用の陸上競技場で、走る喜びを体感しながら運動能力を伸ばせる人気教室！※現在満員のため体験受付を一時停止中（キャンセル待ち登録を受付中）。',
    level: 'intermediate',
    levelLabel: '発展',
    levelStars: 3,
  ...
  },
  {
    ...
    description: 'かけっこ塾と合同開催。小さなお子様向けのやさしいプログラムで、走る楽しさを知る第一歩。※現在満員のため体験受付を一時停止中（キャンセル待ち登録を受付中）。',
    level: 'beginner',
    levelLabel: 'はじめて',
    levelStars: 1,
...
export const instructors: InstructorData[] = [
  ...
  },
  {
    ...
    classIds: ['kakekko-hop', 'kakekko-approach', 'kakekko-monday', 'rikujo-seiryo'],
    avatarInitial: '星',
    avatarColor: '#854F0B',
  },
  {

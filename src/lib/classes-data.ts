...
export const trackClasses: ClassData[] = [
  ...
  },
  {
    ...
    instructor: '金沢星稜大学陸上競技部、スタータススタッフ',
    instructorTitle: '星稜大学陸上部の現役大学生が直接指導',
    description: '人気の水曜かけっこ塾に加えて新設された月曜クラス。定員15名程度の少人数制で、大学生コーチと一緒に走力アップ！体験受付中。',
    level: 'basic',
    levelLabel: '基本',
    levelStars: 2,
  ...
  },
  {
    ...
    instructorTitle: '星稜大学陸上部の現役大学生が直接指導',
    description: '2026年8月開講の新教室。高学年〜中学生を対象に、専門的な陸上トレーニングで競技力を高めます。定員15名程度。',
    level: 'intermediate',
    levelLabel: '発展',
    levelStars: 3,
...
export const instructors: InstructorData[] = [
  ...
  },
  {
    ...
    classIds: ['kakekko-wed', 'kakekko-monday', 'rikujo-seiryo'],
    avatarInitial: '星',
    avatarColor: '#854F0B',
  },
  {
